...
tv_fritzbox `10.100.0.4`, curie `10.100.0.5`. leguin is on the home
LAN behind the Fritzbox and reaches ada's services through the `tv_fritzbox` tunnel.
...
tv_fritzbox (10.100.0.4) ────┘
   └─ home LAN: leguin (192.168.178.103)
```
